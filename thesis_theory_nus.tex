...
\centering
  ...
  \subfloat[Predictions and Measurements of the atmospheric flux of electron and
    muon neutrinos. Figure taken from \cite{IC_AtmCscd}.
    \label{fig:AtmFlux}]
...
Main components of these particle showers are muons and pions. Due to their
high Lorentz boost, the muons have a free path of several kilometers \cite{PDG},
so that most of them can penetrate the Earth's surface and decay at rest deep
underground. 
