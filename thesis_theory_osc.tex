...
\begin{figure}
 \centering
 \includegraphics[width=0.6\textwidth]{NMH}
...
\begin{equation}
 \dm{} \equiv m_3^2 - \left(m_2^2 + m_1^2\right)/2 = \frac{\dm{31}+\dm{32}}{2}
   ...
   \end{cases}
\end{equation}
The values and $1\sigma$ ranges given in \cite{Fogli2012} for $\delta m$,
...
Comparing the different flavours one notes that the largest overall scale of the
