...
precision \cite{SNO}. Clear signs for a MSW resonance were detected for the
solar \nue\footnote{No antineutrinos are produced in the Sun, cf.\
Sec~\ref{sec:NuSources}} travelling through the high electron density of the
...
splitting \dm{31}. Here the matter potential of the Earth will be used to
