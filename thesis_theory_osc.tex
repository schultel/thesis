...
\begin{figure}[th]
 ...
 \caption{\nue disappearance probability (qualitatively) as a function of the 
  distance $t$ (measured in units of the Earth's diameter) along the neutrino 
  trajectory. Figure adopted from \cite{ParamRes2}.}
 \label{fig:ParamRes}
\end{figure}
