...
\begin{eqnarray}
 \Delta A &=& \sqrt{(\Delta\Re)^2 + (\Delta\Im)^2} = \sqrt{2 N_\mathrm{tot}}\\
 \Delta \phi &=& \Delta A / A \quad .
\end{eqnarray}

These are shown in the middle and right panel of Fig.~\ref{fig:JUNO_FFT},
where one can see that the amplitude of the spectrum is virtually independent
