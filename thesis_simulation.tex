...
The full PMT charge output, or ``waveform'', is then passed to the main
...
potential (see Sec.~\ref{sec:matter_osc}) has to be solved numerically.
However, 
...
The calculation of the oscillation probabilities is the most time-consuming of
the whole simulation as here all the
...
\begin{figure}
 ...
 $\begin{array}{cc}
   \mathrm{Tracks} &
   \mathrm{Cascades}\\
   \includegraphics[width=0.5\columnwidth]{1_un_oscillated_trck} &
   \includegraphics[width=0.5\columnwidth]{1_un_oscillated_cscd}\\
   \includegraphics[width=0.5\columnwidth]{2_oscillated_trck} &
   \includegraphics[width=0.5\columnwidth]{2_oscillated_cscd}\\
   \includegraphics[width=0.5\columnwidth]{3_reconstructed_trck} &
   \includegraphics[width=0.5\columnwidth]{3_reconstructed_cscd}\\
   \includegraphics[width=0.5\columnwidth]{4_classified_trck} &
   \includegraphics[width=0.5\columnwidth]{4_classified_cscd}
  \end{array}$
