...
\begin{description}
 ...
 \item[The relative flux normalisation 
  $\mathbf{r_{\mathrm{flux},\,\nue-\numu}}$]
%  TODO: actually implement it this way!
...
%   \end{equation}
 \item[The PID scaling $\mathbf{s_\mathrm{PID}}$] simply scales the probability
 ...
 \item[The PID offset $\mathbf{\Delta_\mathrm{PID}}$] shifts the whole flavour
  ...
  The actual PID function will hence be
  \begin{equation}
