...
To obtain event rates, the neutrino fluxes are multiplied by the effective
areas of PINGU for $\nu_e/\bar\nu_e$, $\nu_\mu/\bar\nu_\mu$ and
...
% Two more systematic parameters can enter at this stage, if parametrized point
...
% \end{description}
% TODO: consider this
% For the tabulated reconstruction approach, this effect also represents the
% uncertainty on the reconstruction resolutions obtained from MC simulations,
% e.g.
% due to inaccurate modelling of the ice parameters.
% -> Für die Tabellen gibts die Parameter nicht!
% While we generally do not expect to have systematic effects in the directional
% reconstruction to provide this simple scaling, we find that the impact of this
% parameters is comparatively low.
% -> Leider ist der Impact sogar ziemlich groß...
