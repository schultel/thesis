...
\item[Photon capture efficiency]
 \begin{figure}[t]
  \centering
%   \includegraphics[width=0.5\textwidth]{icrc2013-0857-02}
...
\begin{figure}[bht]
  \centering
%   \includegraphics[width=0.5\textwidth]{figures/ang_eff_both}
...
\begin{figure}[tbh]
  \centering
%   \includegraphics[width=0.5\textwidth]{figures/all_modules_QE}
...
The result, assuming optimal illumination (i.e.\ $\vartheta=90^\circ$), is shown 
...
DOM    & 5.36\,\%        & 34.1\,\%                 & 12.9\,cm$^2$  & 800\,Hz    
       \\
% \midrule
% 300 --  & WOM    & 4.39\,\%  & 101\,cm$^2$   & $\approx$\,10\,Hz \\ 
% 600\,nm & DOM    & 7.10\,\%  & 18.0\,cm$^2$  & 800\,Hz           \\ 
\bottomrule
\end{tabular}
...
% where we also include the same calculation for a Cherenkov spectrum between 
% 300 and 600\,nm, corresponding to the
% established IceCube metric.
